            ...
            $verbrauchsgut_result = $verbrauchsgut_result->get_result();
              if($verbrauchsgut_result->num_rows > 0){
                while($row_g = $verbrauchsgut_result->fetch_assoc()){   
                  ...
                  $lieferant_sql = "SELECT * FROM person WHERE id_person = " . $row_g["id_person"] . " AND lieferant = 1 AND id_gehoeft = $id_gehoeft";
                  ...
                  $notlieferant_sql = "SELECT * FROM person WHERE lieferant = 1 AND id_gehoeft = $id_gehoeft";
                ...
                echo "<label>Lieferant</label>";
                echo "<select class=\"form-control custom-select\" name=\"id_person\">";
                $lieferantall_sql = "SELECT * FROM person WHERE lieferant = 1 AND id_gehoeft = $id_gehoeft";
